# OK Policy Quarto Templates

Starter templates for Quarto reports and websites.

## To use the templates

```bash
quarto use template openjusticeok/okpolicy-quarto-templates/templates/okpolicy-report-template
