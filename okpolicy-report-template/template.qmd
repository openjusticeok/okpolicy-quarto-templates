...
This is a [link to some url](https://github.com/openjusticeok/okpolicy-quarto-templates).

::: {.content-hidden when-profile="public"}
**Draft note:** This note will not appear in the public build.
:::
...
::: {.content-hidden when-profile="public"}
### Draft note
- Example of staff notes section
:::
...
Another example of a note that will not appear in the public build
:::
